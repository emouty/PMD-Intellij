...
public class PMDUtil {
    ...
    /**
     * Posts {@code content} as JSON to {@code url} with short timeouts. Returns an empty string
     * on success (a socket timeout counts: the endpoint sends no response), else the failure message.
     */
