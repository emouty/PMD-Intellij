...
public interface PmdRunner {
    ...
    /**
     * Tool-window analysis path. {@code files} maps each file to its language/version, already
     * resolved by the caller. Returns rule / suppressed / useless-suppression branch nodes ready
     * to insert under the ruleset node.
     */
    @NotNull
     ...
     * of the JARs loaded by this runner's classloader: the real loaded library, not the configured
     * request.
     */
    @NotNull
